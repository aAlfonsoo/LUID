...
import { goBack, spellingGames, numbers, colours, animals, fruitsVeg, genVocab, } from "../assets/images";

function SpellingNav() {
    const navigate = useNavigate();
    const handleGoBack = () => navigate(-1);
    const redirectTranslation = (category) => {
        navigate('/spelling', { state: { category } });
    };
    ...
    return (
        <div>
            ...
            <img src={spellingGames} alt="Spelling Games" className="navImage" />
